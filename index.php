		...
		<div class="container">
			...
			<div class="content">
				...
				<table id="pages" class="condensed-table table">
					...
					<tbody>
					<?php foreach ($files as $file) { ?><?php if ($file!='.' && $file!='..' && is_dir($file)==false && $file[0]!='_' && $file[0]!='.' && $file!='index.php' && (contains('.htm',$file) || contains('.html',$file)|| contains('.php',$file))) { ?>
						<tr>
							<td style="width:20px;"><?php echo ++$counter; ?>.</td>
							<td>
								<a href="<?php echo $file; ?>"<?if($_REQUEST["frame"] != "y"):?> target="_blank"<?endif?>>
